...
echo ""
echo "  To start a new project (run from wherever you keep your projects, e.g. ~/Documents):"
echo "    vit init your-project-name    (creates the folder + git repo)"
echo "    cd your-project-name"
echo "    vit collab setup              (connect to a GitHub repo for sharing)"
echo ""
echo "  Then in DaVinci Resolve:"
echo "    1. Open your project and timeline in Resolve"
echo "    2. Go to Workspace > Scripts > Vit to open the panel"
echo "    3. The panel handles everything from there (save, branch, merge, push, pull)"
echo ""
