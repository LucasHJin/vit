...
Write-Host ""
Write-Host "  To start a new project (run from wherever you keep your projects, e.g. Documents):"
Write-Host "    vit init your-project-name    (creates the folder + git repo)"
Write-Host "    cd your-project-name"
Write-Host "    vit collab setup              (connect to a GitHub repo for sharing)"
Write-Host ""
Write-Host "  Then in DaVinci Resolve:"
Write-Host "    1. Open your project and timeline in Resolve"
Write-Host "    2. Go to Workspace > Scripts > Vit to open the panel"
Write-Host "    3. The panel handles everything from there (save, branch, merge, push, pull)"
Write-Host ""
